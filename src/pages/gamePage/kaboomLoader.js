...
export function loadAssets(k) {
  ...
  k.loadSprite("player2", "/src/assets/sprites/u3.png", {
    sliceX: 8,
    sliceY: 9,
    anims: {
      idle: { from: 0, to: 7, loop: true },
  ...
  k.loadSprite("mob1", "/src/assets/sprites/AlbertJSprite.png", {
   ...
   k.loadSprite("uxui1", "/src/assets/sprites/JanatSprite.png", {
    sliceX: 8,
    sliceY: 9,
    anims: {
      idle: { from: 0, to: 7, loop: true },
  ...
  k.loadSprite("uxui2", "/src/assets/sprites/AidanaSprite.png", {
    sliceX: 8,
    sliceY: 9,
    anims: {
      idle: { from: 0, to: 7, loop: true },
